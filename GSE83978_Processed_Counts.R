...
## The data in the supp files I downloaded are labelled as processed counts.
...
## y is a large EList with expression data stored in y$E and all of the sample info I put in d$samples is stored to y$targets
